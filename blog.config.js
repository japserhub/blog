...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'hostvpn', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '分享便宜机场', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://hostvpn.info', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '机场, 主机,vpn', // 网站关键词 英文逗号隔开
